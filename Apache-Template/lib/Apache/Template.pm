...
#
# REVISION
#   $Id: Template.pm,v 1.5 2005/07/25 15:55:45 geoff Exp $
#
#========================================================================
...
use Apache2::Const -compile => qw(OK SERVER_ERROR TAKE1 TAKE12 FLAG
                                 ITERATE TAKE2 RSRC_CONF ACCESS_CONF);
...
sub handler {
    ...
    unless (defined $content) {
        $r->log_error($service->error(), ' ', $r->filename());
        return Apache2::Const::SERVER_ERROR;
    }
...
=head1 SYNOPSIS
    ...
    # NOTE: this is _not_ PerlModule but PerlLoadModule
    ...
    # now define Apache::Template as a PerlResponseHandler, e.g.
    <Files *.tt2>
...
Port to Apache/mod_perl 2.0 by Geoffrey Young 
E<lt>geoff@modperlcookbook.orgE<gt>

=head1 VERSION

This is version 2.00_01 of the Apache::Template module.
